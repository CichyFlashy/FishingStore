...
<div class="d-flex align-items-center gap-3">
 ...
 <!-- Hero Section -->
  ...
  <!-- Sekcja marek -->
<section class="brands py-5 text-center bg-light-blue">
        <div class="container">
            <h2>Nasze marki</h2>
            <div class="row justify-content-center mt-4">
                <div class="col-4 col-md-2"><img src="../images/mistrall.png" alt="Mistrall" class="img-fluid"></div>
                <div class="col-4 col-md-2"><img src="../images/robinson.png" alt="Robinson" class="img-fluid"></div>
                <div class="col-4 col-md-2"><img src="../images/jaxon.jpg" alt="Jaxon" class="img-fluid"></div>
                <div class="col-4 col-md-2"><img src="../images/mikado.png" alt="Mistrall" class="img-fluid"></div>
                <div class="col-4 col-md-2"><img src="../images/cralusso.jpg" alt="Robinson" class="img-fluid"></div>
                <div class="col-4 col-md-2"><img src="../images/browning.png" alt="Jaxon" class="img-fluid"></div>
   ...
   <!-- Sekcja promocji -->
<section class="promo py-5 custom-bg">
    <div class="container">
        <h2 class="text-center mb-4">Promocje</h2>
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 justify-content-center">
            <div class="col">
                <div class="card h-100 mx-auto">
                    <img src="../images/stinger.png" class="card-img-top" alt="Wędka">
                    <div class="card-body">
                        <h5 class="card-title">Wędka Robinson Stinger X-Cross Feeder 3,30m 20-60g</h5>
                        <p class="card-text"><span class="text-danger fw-bold">200 zł</span> <del>230 zł</del></p>
            ...
            <div class="col">
                <div class="card h-100 mx-auto">
                    <img src="../images/roxten.jpg" class="card-img-top" alt="Wędka">
                    <div class="card-body">
                        <h5 class="card-title">Kołowrotek Mistrall Roxten Method Feeder FD50</h5>
                        <p class="card-text"><span class="text-danger fw-bold">170 zł</span> <del>199 zł</del></p>
                        <a href="#" class="btn btn-primary">Sprawdź</a>
                    </div>
                </div>
            </div>
          ...
          <div class="col">
                <div class="card h-100 mx-auto">
                    <img src="../images/haczyki.jpg" class="card-img-top" alt="Wędka">
                    <div class="card-body">
                        <h5 class="card-title">Haczyki wędkarskie Sensas 4530 Bronze</h5>
                        <p class="card-text"><span class="text-danger fw-bold">5.99 zł</span> <del>7.99 zł</del></p>
                        <a href="#" class="btn btn-primary">Sprawdź</a>
                    </div>
                </div>
            </div>
          ...
          <div class="col">
                <div class="card h-100 mx-auto">
                    <img src="../images/zylka.png" class="card-img-top" alt="Wędka">
                    <div class="card-body">
                        <h5 class="card-title">Żyłka Mikado Sensual N.G Classic 0.18 mm /150m</h5>
                        <p class="card-text"><span class="text-danger fw-bold">10.99 zł</span> <del>12.99 zł</del></p>
                        <a href="#" class="btn btn-primary">Sprawdź</a>
                    </div>
                </div>
            </div>
